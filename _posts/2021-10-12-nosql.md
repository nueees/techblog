...
#wal_log_hints = off                    # also do full page writes of non-critical up
dates
                                        # (change requires restart)
...
# limit 으로 조회
db.marks.aggregate([{"$limit":3}]) 
> { "_id" : ObjectId("62344250a953db5edbad218b"), "name" : "Ramesh", "subject" : "maths", "marks" : 87 }
  { "_id" : ObjectId("62344250a953db5edbad218c"), "name" : "Ramesh", "subject" : "english", "marks" : 59 }
  { "_id" : ObjectId("62344250a953db5edbad218d"), "name" : "Ramesh", "subject" : "science", "marks" : 77 }
  
db.marks.aggregate([{"$sort":{"marks":-1}}]) # order by marks desc
> { "_id" : ObjectId("62344250a953db5edbad2195"), "name" : "Steve", "subject" : "english", "marks" : 89 }
{ "_id" : ObjectId("62344250a953db5edbad218b"), "name" : "Ramesh", "subject" : "maths", "marks" : 87 }
{ "_id" : ObjectId("62344250a953db5edbad2193"), "name" : "Alison", "subject" : "science", "marks" : 86 }
{ "_id" : ObjectId("62344250a953db5edbad2191"), "name" : "Alison", "subject" : "maths", "marks" : 84 }
{ "_id" : ObjectId("62344250a953db5edbad218f"), "name" : "Rav", "subject" : "english", "marks" : 83 }
{ "_id" : ObjectId("62344250a953db5edbad2192"), "name" : "Alison", "subject" : "english", "marks" : 82 }
{ "_id" : ObjectId("62344250a953db5edbad2194"), "name" : "Steve", "subject" : "maths", "marks" : 81 }
{ "_id" : ObjectId("62344250a953db5edbad218d"), "name" : "Ramesh", "subject" : "science", "marks" : 77 }
{ "_id" : ObjectId("62344250a953db5edbad2196"), "name" : "Steve", "subject" : "science", "marks" : 77 }
{ "_id" : ObjectId("62344250a953db5edbad2190"), "name" : "Rav", "subject" : "science", "marks" : 71 }
{ "_id" : ObjectId("62344250a953db5edbad218e"), "name" : "Rav", "subject" : "maths", "marks" : 62 }
{ "_id" : ObjectId("62344250a953db5edbad218c"), "name" : "Ramesh", "subject" : "english", "marks" : 59 }
{ "_id" : ObjectId("62344250a953db5edbad2197"), "name" : "Jan", "subject" : "english", "marks" : 0, "reason" : "absent" }
```
