...
1) Cluster: 단일 인스턴스 영역 내에 논리적 그룹 (i1)
2) Partition: 여러 인스턴스 영역을 나누어 논리적 파티션을 나눔 (각 인스턴스 그룹이 서로 기본 하드웨어를 공유하지 않음) (i1)(i2)(i3)
3) Spread: 소규모의 인스턴스 그룹을 다른 기본 하드웨어로 물리적으로 분산하여 영역 나누어 관리 (i1_1) (i1_2) (i1_3)
...
## 1.3. AWS Marketplace 사용 (registry hub)
